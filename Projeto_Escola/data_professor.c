...
int validar_data_professor(Data_Professor data_professor)
{
    ...
    if(data_professor.ano_professor <= 0 || data_professor.dia_professor > 31 || data_professor.mes_professor < 1 || data_professor.mes_professor > 12 || data_professor.dia_professor < 1)
    {
