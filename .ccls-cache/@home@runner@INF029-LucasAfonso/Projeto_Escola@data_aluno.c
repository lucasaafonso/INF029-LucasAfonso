...
int validar_data_aluno(Data_Aluno data_aluno)
{
    ...
    if(data_aluno.ano_aluno <= 0 || data_aluno.dia_aluno > 31 || data_aluno.mes_aluno < 1 || data_aluno.mes_aluno > 12 || data_aluno.dia_aluno < 1)
    {
    ...
    {
        int bissexto = (data_aluno.ano_aluno % 4 == 0 && data_aluno.ano_aluno % 100 != 0) || (data_aluno.ano_aluno % 400 == 0);
