...
int main_disciplina(Disciplina lista_disciplina[], int quantidade_disciplinas)
{
    ...
    while(!sair)
    {
        ...
        switch(opcao)
        {
            ...
            case 4:
            {
                int quantidade_alunos_disciplinas = incluir_aluno_disciplina(lista_disciplina, quantidade_disciplinas);
                quantidade_alunos_disciplinas++;
                system("clear");
                break;
            }
            case 5:
...
void listar_disciplina(Disciplina lista_disciplina[], int quantidade_disciplinas)
{
    ...
    for(int i = 0; i < quantidade_disciplinas; i++)
    {
        ...
        printf("\nProfessor da disciplina:\n%s", professor_disciplina.nome_professor);
        printf("\n");
    }
    printf("\n");
}
        ...
        while(!sair)
        {
            ...
            switch(opcao)
            {
                ...
                case 1:
                {
                    ...
                    scanf("%d", &aux.aluno_matricula[qtd]);
                    system("clear");
                ...
                case 2:
                {
                    printf("Lista de alunos da Disciplina: %s\n", lista_disciplina[posicao].nome_disciplina);

                    for(int i = 0; i < qtd; i++)
                    {
                        Aluno aluno_disciplina = get_aluno_aux(aux.aluno_matricula[i]);
                        printf("\nAluno %d: %s", i, aluno_disciplina.nome_aluno);
                    }
                    break;
                }
                default:
