...
int posicao_aluno(Aluno lista_aluno[], int quantidade_aluno,
                  int matricula_aluno);
...
int inserir_aluno(Aluno lista_aluno[], int quantidade_aluno) {
  ...
  lista_aluno[quantidade_aluno].sexo_aluno =
      toupper(lista_aluno[quantidade_aluno].sexo_aluno);
  if (lista_aluno[quantidade_aluno].sexo_aluno != 'M' &&
      lista_aluno[quantidade_aluno].sexo_aluno != 'F') {
  ...
  scanf("%d",
        &lista_aluno[quantidade_aluno].data_de_nascimento_aluno.dia_aluno);
  printf("Digite o mes de nascimento: ");
  scanf("%d",
        &lista_aluno[quantidade_aluno].data_de_nascimento_aluno.mes_aluno);
  printf("Digite o ano de nascimento: ");
  scanf("%d",
        &lista_aluno[quantidade_aluno].data_de_nascimento_aluno.ano_aluno);
  int data_valida_aluno = validar_data_aluno(
      lista_aluno[quantidade_aluno].data_de_nascimento_aluno);
...
void listar_aluno(Aluno lista_aluno[], int quantidade_aluno) {
  ...
  for (int i = 0; i < quantidade_aluno; i++) {
    ...
    printf("Data de nascimento do aluno:\n%d/%d/%d\n",
           lista_aluno[i].data_de_nascimento_aluno.dia_aluno,
           lista_aluno[i].data_de_nascimento_aluno.mes_aluno,
           lista_aluno[i].data_de_nascimento_aluno.ano_aluno);
...
int excluir_aluno(Aluno lista_aluno[], int quantidade_aluno) {
  ...
  int buscar_posicao_aluno =
      posicao_aluno(lista_aluno, quantidade_aluno, matricula_aluno);
...
int atualizar_aluno(Aluno lista_aluno[], int quantidade_aluno) {
  ...
  if (posicao == ALUNO_NAO_ENCONTRADO) {
    ...
    if (aluno_atualizado.sexo_aluno != 'M' &&
        aluno_atualizado.sexo_aluno != 'F') {
      return ERRO_SEXO_ALUNO;
    }
    ...
    scanf("%d",
          &lista_aluno[quantidade_aluno].data_de_nascimento_aluno.ano_aluno);
    int data_valida_aluno =
        validar_data_aluno(aluno_atualizado.data_de_nascimento_aluno);
    if (data_valida_aluno == DATA_ALUNO_ERRO) {
      return DATA_ALUNO_ERRO;
    }
    getchar();
