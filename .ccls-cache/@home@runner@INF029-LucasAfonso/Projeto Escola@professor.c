...
int inserir_professor(Professor lista_professor[], int quantidade_professor) {
  ...
  lista_professor[quantidade_professor].sexo_professor =
      toupper(lista_professor[quantidade_professor].sexo_professor);
  if (lista_professor[quantidade_professor].sexo_professor != 'M' &&
      lista_professor[quantidade_professor].sexo_professor != 'F') {
    return ERRO_SEXO_PROFESSOR;
  }

  printf("\nData de nascimento do professor:\n");
  printf("Digite o dia de nascimento: ");
  scanf("%d", &lista_professor[quantidade_professor]
                   .data_de_nascimento_professor.dia_professor);
  printf("Digite o mes de nascimento: ");
  scanf("%d", &lista_professor[quantidade_professor]
                   .data_de_nascimento_professor.mes_professor);
  ...
  lista_professor[quantidade_professor].matricula_professor =
      matricula_professor();
...
void listar_professor(Professor lista_professor[], int quantidade_professor) {
  ...
  for (int i = 0; i < quantidade_professor; i++) {
    ...
    printf("Data de nascimento do professor:\n%d/%d/%d\n",
           lista_professor[i].data_de_nascimento_professor.dia_professor,
           lista_professor[i].data_de_nascimento_professor.mes_professor,
           lista_professor[i].data_de_nascimento_professor.ano_professor);
...
Professor get_professor(Professor lista_professor[], int quantidade_professor,
                        int matricula) {

  Professor aux;

  for (int i = 0; i < quantidade_professor; i++) {
    if (lista_professor[i].matricula_professor == matricula) {
      return lista_professor[i];
    }
  }
...
int posicao_professor(Professor lista_professor[], int quantidade_professor,
                      int matricula_professor) {
  for (int i = 0; i < quantidade_professor; i++) {
...
int excluir_professor(Professor lista_professor[], int quantidade_professor) {
  ...
  int buscar_posicao_professor = posicao_professor(
      lista_professor, quantidade_professor, matricula_professor);
...
int atualizar_professor(Professor lista_professor[], int quantidade_professor) {
  ...
  int posicao =
      posicao_professor(lista_professor, quantidade_professor, matricula);
  ...
  if (posicao == PROFESSOR_NAO_ENCONTRADO) {
    ...
    professor_atualizado.sexo_professor =
        toupper(professor_atualizado.sexo_professor);
    if (professor_atualizado.sexo_professor != 'M' &&
        professor_atualizado.sexo_professor != 'F') {
      return ERRO_SEXO_PROFESSOR;
    }
    ...
    scanf("%d",
          &professor_atualizado.data_de_nascimento_professor.dia_professor);
    printf("Digite o mes de nascimento do professor:\n");
    scanf("%d",
          &professor_atualizado.data_de_nascimento_professor.mes_professor);
    printf("Digite o ano de nascimento do professor:\n");
    scanf("%d",
          &professor_atualizado.data_de_nascimento_professor.ano_professor);
    int data_valida_professor = validar_data_professor(
        professor_atualizado.data_de_nascimento_professor);
    if (data_valida_professor == DATA_PROFESSOR_ERRO) {
      return DATA_PROFESSOR_ERRO;
    }
    getchar();
    ...
    professor_atualizado.matricula_professor =
        lista_professor[posicao].matricula_professor;
